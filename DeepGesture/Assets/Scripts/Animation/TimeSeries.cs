...
public class TimeSeries {
	...
	public int Pivot => PastSampleCount;
	public int SampleCount => PastSampleCount + FutureSampleCount + 1;
	public int PastSampleCount => PastKeys * Resolution;
	public int FutureSampleCount => FutureKeys * Resolution;

	public int PivotKey => PastKeys;
	public int KeyCount => PastKeys + FutureKeys + 1;
	public float Window => PastWindow + FutureWindow;

	public float DeltaTime => Window / SampleCount;
