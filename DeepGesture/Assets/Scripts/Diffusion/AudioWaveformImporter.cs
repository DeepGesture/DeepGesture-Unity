...
namespace OpenHuman {
	public class AudioWaveformImporter : BatchProcessor {

		public string Source = string.Empty;
		public string Destination = string.Empty;
		public int Framerate = 60;

		[MenuItem("OpenHuman/Diffusion/Audio Waveform Importer")]
		static void Init() {
			Window = EditorWindow.GetWindow(typeof(AudioWaveformImporter));
			Scroll = Vector3.zero;
		}
		...
		public override void DerivedInspector() {
			...
			if (GUILayout.Button("O", GUILayout.Width(20))) {
				Source = EditorUtility.OpenFolderPanel("Audio Waveform Importer", Source == string.Empty ? Application.dataPath : Source, "");
				GUIUtility.ExitGUI();
			}
