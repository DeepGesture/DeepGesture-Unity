...
namespace OpenHuman {
	public class BVHDiffusionImporter : BatchProcessor {
		...
		[MenuItem("OpenHuman/Diffusion/BVH Diffusion Importer")]
		static void Init() {
			Window = EditorWindow.GetWindow(typeof(BVHDiffusionImporter));
			Scroll = Vector3.zero;
		}
		...
		public override IEnumerator DerivedProcess(Item item) {
			...
			if (!Directory.Exists(target)) {
				...
				Debug.Log("Go 222here" + "DerivedProcess");
...

				{
					...
					string m_audioPath = "Assets/DeepGesture/Diffusion";
